...
try:
    ...
    from app.views import LoginWindow, UserWindow, AdminWindow
...
class SistemaChamadosApp:
    ...
    def load_styles(self):
        """Lê o arquivo .qss e aplica na aplicação"""
        file_path = "style.qss"
        if os.path.exists(file_path):
            try:
                ...
                print(f">>> Estilo '{file_path}' carregado com sucesso.")
            except Exception as e:
                print(f"!!! Erro ao ler arquivo de estilo: {e}")
        else:
            print(f"!!! Arquivo '{file_path}' não encontrado. Rodando sem estilos.")
